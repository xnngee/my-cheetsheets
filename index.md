...
*Отменить изменения в рабочем дереве и индексе*
  ...
  *Отменить последний коммит, изменения оставить в индексе*
  - `git reset HEAD~1` \
  *Отменить последний коммит, изменения оставить, но не в индексе*
...
first (03055cf3a9bf7f553705712252dc960f4d03a4ed edited!)
