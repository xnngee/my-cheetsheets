...
Для удаления ветки во внешнем репозитории используйте: `git push origin --delete <origin/branch>`. После этого команда `git ls remote` покажет, что ветка удалена из удаленного репозитория.
